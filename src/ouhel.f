...
c
      return
c
 910  format(/4x,i6,2x,i6,4(3x,e26.19))
 911  format(/12x,i6,4(3x,e26.19))
 930  format(/4x,i6,8x,4(3x,e26.19))
 931  format(18x,4(3x,e26.19))
c
 912  format(/4x,i6,2x,i6,4(3x,f26.16))
 913  format(/12x,i6,4(3x,f26.16))
 932  format(/4x,i6,8x,4(3x,f26.16))
 933  format(18x,4(3x,f26.16))
c
 914  format(/4x,i6,2x,i6,2(3x,e26.19))
 915  format(/12x,i6,2(3x,e26.19))
 934  format(/4x,i6,8x,2(3x,e26.19))
 935  format(18x,2(3x,e26.19))
c
 916  format(/4x,i6,2x,i6,2(3x,f26.16))
 917  format(/12x,i6,2(3x,f26.16))
 936  format(/4x,i6,8x,2(3x,f26.16))
 937  format(18x,2(3x,f26.16))
c
 918  format(/4x,i6,2x,i6,4x,e12.5,5(8x,e12.5))
 919  format(/12x,i6,4x,e12.5,5(8x,e12.5))
 938  format(/4x,i6,4x,6(8x,e12.5))
 939  format(14x,6(8x,e12.5))
c
 920  format(/4x,i6,2x,i6,4x,f12.6,5(8x,f12.6))
 921  format(/12x,i6,4x,f12.6,5(8x,f12.6))
 940  format(/4x,i6,4x,6(8x,f12.6))
 941  format(14x,6(8x,f12.6))
c
 922  format(/4x,i6,2x,i6,4x,e12.5,2(8x,e12.5))
 923  format(/12x,i6,4x,e12.5,2(8x,e12.5))
 942  format(/4x,i6,4x,3(8x,e12.5))
 943  format(14x,3(8x,e12.5))
c
 924  format(/4x,i6,2x,i6,4x,f12.6,2(8x,f12.6))
 925  format(/12x,i6,4x,f12.6,2(8x,f12.6))
 944  format(/4x,i6,4x,3(8x,f12.6))
