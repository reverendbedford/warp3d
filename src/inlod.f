...
#sgl      real 
     ...
     &     press_set(numfaces), matchs, endcrd, true, label,
     &     numd, scanms, numi, integr, debug, constraint_factor,
     &     pist_set(numfaces), abaqus_face_flag, string
      dimension intlst(mxlsz), step_load_list(mxlc),
     &          list_of_steps(mxstep)
...
c     *                       written by : rhd                       *
c     *                                                              *
c     *                   last modified :  08/16/2013 rhd            *
c     *                                                              *
c     ****************************************************************
c
c
