...
c             we consider planar quadrilaterals with either 2x2 or 3x3 integration.
c
c             order_face  2 = 2x2
...
c
c             9. calculate ui,1_aux at gp for all loading modes, p-stress, p-strain.
c                these are the same expressions for ui,1 that are in subroutine
c                di_calc_aux_fields_k, and di_calc_aux_fields_t, but are simplified
c                for theta = +/- pi.
c
         du11_aux(1:7) = zero
         du21_aux(1:7) = zero
...
c
 ...
 1121 format(/,10x,'distance, closest pair: ',2x,e13.6,2x,i6 )
