...
c
     ...
     &           history_n(iloop,1), span, crys_no, hist_sz )
      end if
c      
...
c
      ...
      logical :: process_G_H
c
      h_type  = local_work%c_props(1,1)%h_type
...
c     *                       written by : mcm                       *
c     *                                                              *
c     *                   last modified: 10/2/2016 rhd               *
c     *                                                              *
c     *    Initialize a crystal history variables                    *
c     *                                                              *
c     ****************************************************************
c
      subroutine mm10_init_cc_hist0( props, angles, history, span,
     &                               crys_no, hist_size )
      use mm10_defs
      use mm10_constants
      implicit none
...
c              plastic strain and work
      ...
      call mm10_form_dbarp( props, np1, n,vec1, vec2, np1%stress,
     &                      np1%tau_tilde, dbarp )
