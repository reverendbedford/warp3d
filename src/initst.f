...
c
c
      call setelb(nlibel,elelib,outmap,mxlbel)
c
...
c
c
c                       initialize the contact plane data
c
c
      use_contact = .false.
      do i = 1, maxcontact
...
c
c                       element types not current implemented
c
      implemented_ele_types(7)  = .false.
      implemented_ele_types(8)  = .false.
      implemented_ele_types(9)  = .false.
      implemented_ele_types(10) = .false.
      implemented_ele_types(11) = .false.
c
