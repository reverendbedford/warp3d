...
c
 80   continue
      ...
      write(out,9007) nonode,mxnod
 9007 format(/1x,'>>>>> fatal error: ',i6,': the number of nodes in ',
     &           'the structure exceeds'/14x,i6,': the maximum ',
     &           'number of nodes allowed. execution'/14x,'will be ',
     &           'terminated.'/)
      input_ok = .false.
      go to 9999
c
...
c
 1200 continue
      num_error = num_error + 1
      write(out,9117) nodof,mxdof
 9117 format(/1x,'>>>>> error: ',i6,': the number of dof of the ',
     &           'structure exceeds'/14x,i6,': the maximum number of',
     &           ' dof allowed. execution'/14x,'will be terminated.'/)
      input_ok = .false.
      go to 9999
c
c
...
c
 ...
 9035 format(/1x,
     &'>>>>> fatal error: too many mpc equations defined',
     & /,16x,'only ',i8,' mpc equations are allowed',
     & /,16x,'job terminated....'/)
      go to 9999
c
 360  continue
