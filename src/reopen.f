...
c
     ...
     &              mniter, lodhed, restrt, lgnmcn, mxlitr,
...
c
      ...
      call rdbk( fileno, user_cnstrn_stp_factors, mxstep)
      call rdbk( fileno, actual_cnstrn_stp_factors, mxstep)
...
c
      ...
      read(fileno) maplength
      if( maplength .gt. 0 ) then
