...
c
 200  continue
      ...
      go to 30
c
 910  format(//1x,'>>>>> element ',i6//)
 915  format(6x,i6,4(3x,e26.19))
 916  format(12x,4(3x,e26.19))
 917  format(6x,i6,4(3x,f26.16))
 918  format(12x,4(3x,f26.16))
c
 920  format(6x,i6,2(3x,e26.19))
 921  format(12x,2(3x,e26.19))
 922  format(6x,i6,2(3x,f26.16))
 923  format(12x,2(3x,f26.16))
c
 925  format(6x,i6,6(8x,e12.5))
 926  format(12x,6(8x,e12.5))
 927  format(6x,i6,6(8x,f12.6))
 928  format(12x,6(8x,f12.6))
c
 930  format(6x,i6,3(8x,e12.5))
 931  format(12x,3(8x,e12.5))
 932  format(6x,i6,3(8x,f12.6))
 933  format(12x,3(8x,f12.6))
c
 945  format(1x,' ')
c
 9999 return
